...
public class MonarchConstants extends Constants {
  public MonarchConstants() {
    ...
    Intake.Left.k_groundPosition = 0.1883605718612671; //0.19023025035858154;
    ...
    Intake.Right.k_groundPosition = 0.849852442741394; //0.850831151008606; //0.8430086374282837;
